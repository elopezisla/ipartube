		...
		<c:forEach items="${videos}" var="v">
			<tr>
				...
				<td><a class="btn btn-sm btn-primary"
					href="admin/formulario?id=${v.id}"><i class="bi bi-pencil-fill"></i></a>
					<a
					onclick="javascript:return confirm('¿Estás seguro de borrar el video ${i}?')"
					class="btn btn-sm btn-danger" href="admin/borrar?id=${v.id}"><i
